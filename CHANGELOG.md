...
**`gsr_*_fields.png` now exists for C1.** `scripts/figures.jl` drew §5.5 as traces and scatter
...
`SECTION55_SAMPLES = (65, 201)` puts the two spacings within 1 % of each other — `6/64 = 0.0938`
